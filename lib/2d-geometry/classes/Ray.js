...
export class Ray extends Shape {
    ...
    constructor(pt, norm) {
        super();
        this.pt = pt !== null && pt !== void 0 ? pt : geom.Point.EMPTY;
        this.norm = norm !== null && norm !== void 0 ? norm : new geom.Vector(0, 1);
    }
    /**
     ...
     */
    rotate(angle, center = geom.Point.EMPTY) {
...
export const ray = (pt, norm) => new Ray(pt, norm);
