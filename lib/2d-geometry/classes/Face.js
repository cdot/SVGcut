import CircularLinkedList from '../data_structures/circular_linked_list.js';
import * as Utils from '../utils/utils.js';
import { CW, ORIENTATION } from '../utils/constants.js';
    ...
    static getSelfIntersections(face, edges, exitOnFirst = false) {
        ...
        for (let edge1 of face) {
            ...
            for (let edge2 of resp) {
                ...
                if (edge1.shape instanceof geom.Segment &&
