import { TAU, CW } from '../utils/constants.js';
...
export class Arc extends Shape {
    constructor(a, b, c, d, e) {
        ...
        if (a === undefined)
            return;
        if (a instanceof Object && a.name === 'arc') {
            const { pc, r, startAngle, endAngle, clockwise } = a;
    ...
    get start() {
        var _a;
        return ((_a = this._start) !== null && _a !== void 0 ? _a : (this._start = new Point(this.pc.x + this.r, this.pc.y).rotate(this.startAngle, this.pc)));
    }
    set start(p) {
        this._start = p;
    }
    ...
    get end() {
        var _a;
        return ((_a = this._end) !== null && _a !== void 0 ? _a : (this._end = new Point(this.pc.x + this.r, this.pc.y).rotate(this.endAngle, this.pc)));
    }
    set end(p) {
        this._end = p;
    }
    ...
    distanceTo(shape) {
        if (shape instanceof Point) {
            return Distance.arc2point(this, shape);
        }
        if (shape instanceof Circle) {
            return Distance.arc2circle(this, shape);
        }
        if (shape instanceof Line) {
            return Distance.arc2line(this, shape);
        }
        if (shape instanceof Segment) {
            return Distance.arc2segment(this, shape);
        }
        if (shape instanceof Arc) {
            return Distance.arc2arc(this, shape);
        }
        if (shape instanceof Polygon) {
...
Arc.EMPTY = Object.freeze(new Arc(Point.EMPTY, 0, 0, 0, CW));
/**
 * Function to create arc equivalent to "new" constructor
 */
export const arc = (pc, r, startAngle, endAngle, cw) => new Arc(pc, r, startAngle, endAngle, cw);
