...
import { Inversion } from "../classes/Inversion.js";
...
import { Quadratic } from "../classes/Quadratic.js";
import { Ray } from "../classes/Ray.js";
import { Rect } from "../classes/Rect.js";
import { RoundedRect } from "../classes/RoundedRect.js";
...
import { IntervalTree } from "../data_structures/interval-tree/index.js";
export function reverse(result) {
 ...
 */
export function point2point(a, b) {
    return a.distanceTo(b);
}
/**
 * Calculate distance and shortest segment between point and line
 */
export function point2line(pt, line) {
 ...
 */
export function point2circle(pt, circle) {
 ...
 */
export function point2segment(pt, segment) {
 ...
 */
export function point2arc(pt, arc) {
 ...
 */
export function segment2point(segment, point) {
 ...
 */
export function segment2line(seg, line) {
 ...
 */
export function segment2segment(seg1, seg2) {
 ...
 * @returns {Number | Segment} - distance and shortest segment
 */
export function segment2circle(seg, circle) {
...
export function segment2arc(seg, arc) {
    ...
    if (Utils.GE(dist_from_center, circle.r) && shortest_segment_from_center.end.on(seg)) {
        let [dist_from_projection, shortest_segment_from_projection] = point2circle(shortest_segment_from_center.end, circle);
 ...
 */
export function arc2point(arc, point) {
    return reverse(point2arc(point, arc));
}
/**
 * Calculate distance and shortest segment between an arc and a point
 */
export function arc2segment(arc, segment) {
 ...
 * @returns {Number | Segment} - distance and shortest segment
 */
export function point2polygon(point, polygon) {
    let min_dist_and_segment = [Number.POSITIVE_INFINITY, new g.Segment()];
    for (let edge of polygon.edges) {
        let [dist, shortest_segment] = edge.shape instanceof g.Segment ? point2segment(point, edge.shape) : point2arc(point, edge.shape);
...
export function shape2planarSet(shape, set, min_stop = Number.POSITIVE_INFINITY) {
    let min_dist_and_segment = [min_stop, new g.Segment()];
    let stop = false;
...
export function pythagore(width, height) {
