...
import * as k from '../utils/constants.js';
...
export function ray_shoot(polygon, point) {
    ...
    const searchBox = new Box(ray.box.xmin - Utils.getTolerance(), ray.box.ymin - Utils.getTolerance(), ray.box.xmax, ray.box.ymax + Utils.getTolerance());
