...
const SVG_GROUPS = [
  'contentSvgGroup', 'toolPathsSvgGroup', 'cgSvgGroup', 'selSvgGroup'
];
...
class App {
  ...
  constructor(config) {
     ...
     */
    this.contentSvgGroup = this.mainSnap.group();
    this.contentSvgGroup.attr("id", "contentSvgGroup");
     ...
     * @member {SVGGraphicsElement}
     */
    this.toolPathsSvgGroup = this.mainSnap.group();
    this.toolPathsSvgGroup.attr("id", "toolPathsSvgGroup");

    /**
     * SVG group containing geometry generated by dynamically
     * combining various paths to generate it.
     * @member {SVGGraphicsElement}
     */
    this.cgSvgGroup = this.mainSnap.group();
    this.cgSvgGroup.attr("id", "cgSvgGroup");

    /*CPP this.tabsGroup this.mainSnap.group()
      this.tabsGroup.attr("id", "tabsGroup");
      /CPP*/
    ...
    if (this.options.preloadInBrowser) {
      this.models.Misc.projectKey(this.options.preloadInBrowser);
...
*/
  ...
  /**
   * Load SVG from plain text into the contentSvgGroup. This won't
  ...
  toJson(template) {
    ...
    if (!template) {
      for (const group of SVG_GROUPS)
        container[group] = this[group].outerSVG();
    }
    return container;
  }
