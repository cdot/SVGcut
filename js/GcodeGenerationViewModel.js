...
class GcodeGenerationViewModel extends ViewModel {
  ...
  constructor() {
     ...
     * and Y increases downwards. Internally we use internal
     * coordinates, which follow this pattern. Gcode, on the other hand,
     * assumes Y increases upwards and the origin is at the bottom left of
     * the work area. Because the whole SVG might be much bigger than the
     * actual work (the selected objects used to generate the Gcode) it is
     * useful to be able to realign the Gcode origin with the lower-left
     * corner of the bounding box around the actual work.
     */
     ...
     * SMELL: generate G10,G54 to do this
  ...
  generateGcode() {
    ...
    const cutRate = App.models.Tool.cutRate.toUnits(gunits);
    const passDepth = App.models.Tool.passDepth.toUnits(gunits);
    ...
    App.tutorial(
      5, 'You\'re done! Look at the "Simulate" tab. View your Gcode with "View Gcode". Save your gcode.');
  }
