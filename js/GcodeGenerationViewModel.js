...
class GcodeGenerationViewModel extends ViewModel {
  ...
  constructor() {
    ...
    App.models.Tool.angle.subscribe(() => this.generateGcode("angle"));
    ...
    this.returnTo00.subscribe(() => this.generateGcode("returnTo00"));
    ...
    this.origin.subscribe(() => this.generateGcode("origin"));
    ...
    this.extraOffsetX.subscribe(() => this.generateGcode("extraOffsetX"));
    ...
    this.extraOffsetY.subscribe(() => this.generateGcode("extraOffsetY"));
  ...
  generateGcode(cause) {
    ...
    console.debug("generateGcode...", cause);
